...
With both SequentialEngine and DaftEngine
"""
...
def main():
    ...
    # Original pipeline
    from retrieval import pipeline, inputs
    original_pipeline = pipeline
    
    # Optimized pipeline
    from retrieval_optimized import pipeline_optimized, inputs as inputs_opt
    ...
    for r in results:
        print(f"{r['name']:<20} {r['engine']:<20} {r['time']:<12.2f} {r['ndcg']:<10.4f}")
