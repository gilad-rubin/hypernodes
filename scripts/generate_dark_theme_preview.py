...
from hypernodes.viz.graphviz.style import DESIGN_STYLES, GraphvizTheme, ColorPair, NodeStyle
...
<html>
<head>
    <title>HyperNodes Dark Mode Themes</title>
    <style>
        body { 
        ...
        .card { 
            background: #252526; /* VS Code Sidebar/Card background */
            padding: 20px; 
            border-radius: 8px; 
        ...
        h2 { margin-top: 0; color: #cccccc; text-transform: capitalize; font-size: 1.2em; margin-bottom: 10px; }
        ...
        .chip-label { font-size: 0.75em; color: #aaa; font-weight: bold; }
        .hex-code { font-size: 0.7em; color: #666; font-family: monospace; }
    </style>
</head>
<body>
    <h1>HyperNodes Dark Mode Theme Preview</h1>
    <p>Previewing themes on a dark background (#1e1e1e).</p>
    <div class="container">
"""
...
with open("dark_mode_preview.html", "w") as f:
    f.write(html_content)

print(f"Generated dark_mode_preview.html with {len(DESIGN_STYLES)} options.")
