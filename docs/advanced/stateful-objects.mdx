...
description: 'Manage expensive resources with lazy initialization.'
---
...
- [Caching Guide](/essentials/caching) - How caching works in HyperNodes
- [DaftEngine](/advanced/daft-engine) - Distributed execution with Daft
- [DualNode](/advanced/dual-node) - Combining stateful objects with batch operations
